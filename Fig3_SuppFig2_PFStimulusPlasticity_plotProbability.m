...
% 2. Change the current folder to "Fig3 and Supp Fig2 PFstimulation_plasticity\probability"
% 3. analyze the data within the folder of "Fig3 and Supp Fig2 PFstimulation_plasticity\probability"
...
%% Section 2: plot original calcium probability of each genotype 
% ctrl+enter to run this section
...
arrayfun(@(a) text(a+space,y(a)+ysem(a)+0.06,num2str(y(a),'%4.2f'),...
    'color',co(cnum(a),:),...
...
%% Section 3-1 plot normalized mean+sem
