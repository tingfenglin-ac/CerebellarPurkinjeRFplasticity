...
% 2. Change the current folder to "Fig7 and Supp Fig7 8 Airpuff_map plasticity\probability"
...
markersize=30;
criteria=[0 100];
legendlist={'WT finger control''WT finger nontargeted tetanized' 'WT wrist nontargeted tetanized' 'WT finger tetanus' 'WT wrist tetanus' ...
    'CaMKII finger nontargeted tetanized' 'CaMII wrist nontargeted tetanized' 'CaMKII finger tetanus' 'CaMII wrist tetanus'...
    'SK2 finger nontargeted tetanized' 'SK2 wrist nontargeted tetanized' 'SK2 finger tetanus' 'SK2 wrist tetanus'};
groupnum=3;
clear GOF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% load control data
...
figure;
    ...
    arrayfun(@(a) text(a+space,y(a)+ysem(a)+0.4,num2str(y(a),'%4.2f'),...
        'color',co(cnum(a,1),:,cnum(a,2)),...
    ...
    FS=16;
        ...
        Ysig=1.;Yincre=0.1;sigincre=0.008;
...
%         symbole_pattern={'o-';'o-';'^-';'o-';'^-';'o-';'^-';'o-';'^-';'o-';'^-';'o-';'^-'};
    ...
    Ysig=2.4;Yincre=0.1;sigincre=0.012;
