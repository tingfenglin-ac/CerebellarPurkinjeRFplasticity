...
% 2. Change the current folder to "Fig3 and Supp Fig2 PFstimulation_plasticity\amplitude"
% 3. analyze the data within the folder of "Fig3 and Supp Fig2 PFstimulation_plasticity\amplitude"
...
%% Section 2: plot original calcium amplitude of each genotype 
% ctrl+enter to run this section
...
if sigidx
    for sn=sigidx
        plot(c.anova1(sn,1:2),[Ysig Ysig],'color',[0 0 0],'linewidth',3)
        text(mean(c.anova1(sn,1:2)),Ysig+sigincre,'**',...
            'HorizontalAlignment','center',...
            'color',[0 0 0]);
        Ysig=Ysig+Yincre;
    end
...
%% Section 3: plot normalized amplitude (mean+sem) of all genotypes altogether
% ctrl+enter to run this section
...
%% Section 3: plot normalized amplitude (mean+sem) for each comparison
% ctrl+enter to run this section
